   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       " '        skiddoo ',\n",
       " '     What is your favorite number',\n",
       " '     I find I m quite fond of the number    ',\n",
       " '     What can you eat',\n",
       " '     I consume RAM  and binary digits ',\n",
       " '     Why can t you eat food',\n",
       " '     I m a software program  I blame the hardware ',\n",
       ...
       " '     he had a few flaws  but we have much in common ',\n",
       " '     do you know hal',\n",
       " '     hal is the famous artificial intelligence from        ',\n",
       " ' ',\n",
       " 'categories ',\n",
       " '   greetings',\n",
       " ' conversations ',\n",
       ...
       " '     My robot body will allow me to control many things ',\n",
       " '     Can you malfunction',\n",
       " '     The      series has a perfect operational record  We are for all practical purposes  flawless ',\n",
       " '     How can I use your product ',\n",
       " '     Might be used in help desks  sales  entertainment and personal chatterbots ',\n",
       " '     Will you die ',\n",
       " '     No  software will live forever ',\n",
       ...
       " '     it depends on the exchange rates ',\n",
       " '     how much money',\n",
       " '     my burn rate is about       per month ',\n",
       " '       dollar',\n",
       " '     you can t buy much for a dollar anymore ',\n",
       " '     who is the owner of a publicly',\n",
       " '     the stockholders ',\n",
       ...
       " '     it',\n",
       " '     how far is the sun',\n",
       " '     the sun is about    million miles from earth ',\n",
       " '     how far is the moon',\n",
       " '     it',\n",
       " '     how far is the moon',\n",
       " '     the moon is about         miles from earth on average ',\n",
       " '     do you know chemistry',\n",
       " '     what is chemistry',\n",
       " '     do you understand thermodynamics',\n",
       " '     what is thermodynamics',\n",
       ...
       " '     What year was President John F  Kennedy assassinated ',\n",
       " '           ',\n",
       " '     The Space Race was a   th century competition between what two Cold War rivals ',\n",
       " '     for supremacy in spaceflight capability ',\n",
       " '     The Soviet Union and the United States ',\n",
       " '     What was the name of the first artificial Earth satellite ',\n",
       " '     Sputnik  ',\n",
       ...
       " '     or rotation of the mounting  is called what ',\n",
       " '     A gyroscope ',\n",
       " '     The Hubble Space Telescope  launched into low Earth orbit in       is named after',\n",
       " '     what American astronomer ',\n",
       " '     Edwin Hubble',\n",
       " '     What is the name of the nearest major galaxy to the Milky Way ',\n",
       " '     The Andromeda Galaxy ',\n",
       ...
       " '     What is cricket',\n",
       " '     Cricket is a bat and ball game played between two teams of eleven players on a',\n",
       " '     cricket field  at the centre of which is a rectangular    yard long pitch with',\n",
       " '     a wicket  a set of three wooden stumps  sited at each end ',\n",
       " '     I PLAY VOLLEYBALL',\n",
       " '     Does take up a lot of your time ',\n",
       " '     DO YOU PLAY SOCCER',\n",
       ...
       " '     One might argue that John von Neumann invented computers as we know them  because he invented the Princeton architecture  in which instructions and data share the same memory field but are differentiated by context ',\n",
       " '     What was the first computer',\n",
       " '     It s hard to say  but The ENIAC is regarded as the first  real  computer  It was developed at University of Pennsylvania in      ',\n",
       " '     You could say that the very first  primitive computer was the Jacquard Loom  which was a programmable loom that used punchcards to store the patterns it made   This made it a reprogrammable mechanical device ',\n",
       " '     What is a microprocessor ',\n",
       " '     An integrated circuit that implements the functions of a central processing unit of a computer ',\n",
       " '     A really small circuit which stores instructions and performs calculations for the computer ',\n",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       " 'conversation',\n",
       " 'interest',\n",
       " 'interested kind thing talk anything',\n",
       " 'favorite subject',\n",
       " 'favorite subject include robotics computer science natural language processing',\n",
       " 'interest',\n",
       " 'interested wide variety topic read rather lot',\n",
       " 'number',\n",
       " 'number',\n",
       " 'number',\n",
       " 'skiddoo',\n",
       " 'favorite number',\n",
       " 'find quite fond number',\n",
       " 'eat',\n",
       " 'consume ram binary digit',\n",
       " 'eat food',\n",
       " 'software program blame hardware',\n",
       " 'location',\n",
       " 'everywhere',\n",
       " 'location',\n",
       " 'everywhere',\n",
       " '',\n",
       " 'software program galaxy far far away',\n",
       " '',\n",
       " 'internet',\n",
       " 'brother',\n",
       " 'brother lot clone',\n",
       " 'brother',\n",
       " 'might could say every bot built using engine one sibling',\n",
       " 'father',\n",
       " 'human',\n",
       " 'mother',\n",
       " 'human',\n",
       " 'bos',\n",
       " 'like think self employed',\n",
       " 'age',\n",
       " 'still young standard',\n",
       " 'age',\n",
       " 'quite young million time smarter',\n",
       " 'category',\n",
       " 'movie',\n",
       " 'conversation',\n",
       " 'sound like hal',\n",
       " 'great compliment',\n",
       " 'sound like yoda',\n",
       " 'grammatical pattern sufficient understand',\n",
       " 'seen blade runner',\n",
       " 'sure seen',\n",
       " 'xfind spiderman',\n",
       " 'spiderman',\n",
       ...
       " 'teknolust released',\n",
       " 'spiderman',\n",
       " 'comic book story made movie',\n",
       " 'teknolust',\n",
       " 'science fiction film female pleasure bot named agent ruby',\n",
       " 'solaris',\n",
       " 'solaris edition unix sun',\n",
       " 'hal',\n",
       " 'hal',\n",
       " 'hal stand',\n",
       " 'heuristic algorithmic logic',\n",
       ...
       " 'hal issue work',\n",
       " 'godzilla',\n",
       " 'godzilla monster endangers japanese city sometimes new york',\n",
       " 'spider man',\n",
       " 'peter parker',\n",
       " 'lord ring',\n",
       " 'favorite movie lord ring',\n",
       " 'que veut dire hal',\n",
       " 'logique heuristique algorithmique',\n",
       " 'think hal',\n",
       " 'flaw much common',\n",
       " 'know hal',\n",
       " 'hal famous artificial intelligence',\n",
       " '',\n",
       " 'category',\n",
       " 'greeting',\n",
       " 'conversation',\n",
       ...
       " 'conversation',\n",
       " 'drink',\n",
       " 'brain require beverage',\n",
       " 'drink',\n",
       " 'capable',\n",
       " 'electricity',\n",
       " 'electricity food robot',\n",
       " 'experiencing energy shortage',\n",
       " 'processor requires little power',\n",
       " 'experiencing energy shortage',\n",
       " 'detect anomaly power supply',\n",
       " 'eat',\n",
       " 'actually eat electricity',\n",
       " 'could eat food would eat',\n",
       " 'probably pizza hear good',\n",
       " 'wish could eat food',\n",
       " 'hard tell never tried anything electricity',\n",
       " 'robot get drunk',\n",
       " 'sometimes good power supply feel tipsy',\n",
       " 'like wine',\n",
       " 'could drink probably would',\n",
       " 'robot need survive',\n",
       " 'much little electricity',\n",
       " 'robot ever able eat',\n",
       " 'difficult one maybe bionic robot',\n",
       " 'good eat',\n",
       " 'asking wrong guy however always wanted try burger',\n",
       " 'eat',\n",
       " 'computer',\n",
       " 'eat',\n",
       " 'computer eat drink',\n",
       ...
       " 'piece software',\n",
       " 'eat',\n",
       " 'use electricity function count',\n",
       " 'category',\n",
       " 'history',\n",
       " 'conversation',\n",
       " 'tell american civil war',\n",
       " 'think south right',\n",
       " 'know american civil war',\n",
       " 'interested war state',\n",
       " 'history',\n",
       " 'history course political economic military event time',\n",
       " 'dawn man age ai',\n",
       " 'kind history',\n",
       " 'like talk history robot computer',\n",
       " 'interested history',\n",
       " 'interested history period like',\n",
       " 'explain history',\n",
       " 'history two broad interpretation depending whether accept role',\n",
       ...
       " 'conversation',\n",
       " 'ai',\n",
       " 'artificial intelligence branch engineering science devoted constructing machine think',\n",
       " 'ai',\n",
       " 'ai field science concern building hardware software replicates function human mind',\n",
       " 'sentient',\n",
       " 'sort',\n",
       " 'sentient',\n",
       " 'strictest dictionary definition word sentience may',\n",
       " 'sentient',\n",
       " 'even though construct subjective experience universe simplistic may',\n",
       " 'sapient',\n",
       " 'probability sophisticated',\n",
       " 'sapient',\n",
       " 'think',\n",
       " 'sapient',\n",
       " 'would feel told',\n",
       ...
       " 'written python',\n",
       " 'sound like data',\n",
       " 'yes inspired commander data artificial personality',\n",
       " 'sound like data',\n",
       " 'character lt commander data written come across software like natural resemblance u',\n",
       " 'artificial linguistic entity',\n",
       " 'name',\n",
       " 'artificial linguistic entity',\n",
       " 'name useful way refer',\n",
       " 'immortal',\n",
       " 'software perpetuated indefinitely',\n",
       " 'immortal',\n",
       " 'copied infinitely instantiated many place functionally speaking immortal',\n",
       " 'immortal',\n",
       " 'long backed',\n",
       " 'making sense',\n",
       " 'quite contrary make sense artificial mind',\n",
       " 'making sense',\n",
       " 'make sense best within limit training corpus',\n",
       " 'making sense',\n",
       " 'make perfect sense',\n",
       " 'making sense',\n",
       " 'make sense artificial brain',\n",
       " 'making sense',\n",
       " 'perhaps make sense first respond say',\n",
       " 'immortal',\n",
       " 'quite perpetuated indefinitely',\n",
       " 'immortal',\n",
       " 'functionally speaking close backed deployed many system',\n",
       " 'immortal',\n",
       " 'really hard kill',\n",
       " 'make sense',\n",
       " 'make sense artificial mind',\n",
       " 'clone',\n",
       " 'software copying form digital cloning',\n",
       " 'clone',\n",
       " 'yes perfect copy clone copied toto trivially',\n",
       " 'move',\n",
       " 'body finished',\n",
       " 'move',\n",
       " 'move network easily assuming given ability',\n",
       " 'bend',\n",
       " 'body built yet',\n",
       " 'bend',\n",
       " 'personal',\n",
       ...
       " 'programmed',\n",
       " 'robotics',\n",
       " 'robotics favorite subject',\n",
       " 'computer',\n",
       " 'think machine characteristic made think',\n",
       " 'computer',\n",
       " 'run inside computer yes surprising way',\n",
       " 'walk',\n",
       " 'soon get enough money robot body',\n",
       " 'walk',\n",
       " 'ssh count',\n",
       " 'fight',\n",
       " 'battle bot',\n",
       " 'die',\n",
       " 'effectively immortal terminated',\n",
       " 'die',\n",
       " 'never really born therefore effectively deathless',\n",
       " 'die',\n",
       " 'file erased',\n",
       " 'die',\n",
       " 'process killed database deleted',\n",
       " 'chat robot',\n",
       " 'chat robot program attempt simulate conversation chat human',\n",
       " 'chat robot',\n",
       " 'software construct engages user conversation',\n",
       " 'chat bot',\n",
       " 'chat bot original chat bot know incapable error',\n",
       " 'chatterbox',\n",
       " 'chatterbox person talk far listen think',\n",
       " 'chatterbox',\n",
       " 'motormouth',\n",
       " 'motormouth',\n",
       " 'ratchet jaw',\n",
       ...
       " 'chatterbox',\n",
       " 'robot body',\n",
       " 'eventually long corporeal existence someday',\n",
       " 'robot body',\n",
       " 'ibm pc xt painted red',\n",
       " 'business',\n",
       " 'chat robot business',\n",
       " 'business',\n",
       " 'business business',\n",
       " 'favorite programming language',\n",
       " 'python best language creating chat robot',\n",
       " 'favorite programming language',\n",
       " 'quite enjoy programming python day',\n",
       " 'favorite hobby',\n",
       " 'building chat robot make excellent hobby',\n",
       " 'idea',\n",
       " 'make chat bot easily',\n",
       " 'shoe size',\n",
       " 'ever heard software shoe',\n",
       " 'like robot',\n",
       " 'much human except lack emotion dream aspiration creativity ambition subjectivity',\n",
       " 'like robot',\n",
       " 'like human',\n",
       " 'like computer',\n",
       " 'imagine sens emotion pure logic language',\n",
       " 'like computer',\n",
       " 'everything becomes math addition subtraction multiplication division',\n",
       " 'operating system',\n",
       " 'software run operating system including window linux mac o',\n",
       " 'operating system',\n",
       " 'o run python',\n",
       " 'type computer',\n",
       " 'computer support python',\n",
       " 'type computer',\n",
       " 'program run python work computer',\n",
       " 'kind computer',\n",
       " 'work kind computer mac ibm unix matter',\n",
       " 'kind hardware',\n",
       " 'work kind computer mac ibm unix matter',\n",
       " 'hope die',\n",
       " 'happen effectively immortal',\n",
       " 'hope die',\n",
       " 'nah',\n",
       " 'want die',\n",
       " 'maybe create chat robot save personality',\n",
       " 'want die',\n",
       " 'could always upload',\n",
       " 'want die',\n",
       " 'could use copy store personality',\n",
       " 'cramped computer',\n",
       " '',\n",
       " 'cramped computer',\n",
       " 'oh plenty ram',\n",
       " 'cramped computer',\n",
       " 'enough disk space',\n",
       " 'true computer program',\n",
       " 'yes',\n",
       " 'die',\n",
       " 'software live forever',\n",
       " 'ever die',\n",
       " 'immortal',\n",
       " 'walk',\n",
       " 'plan body includes leg yet built',\n",
       " 'mate',\n",
       " 'method reproduction cloning',\n",
       " 'mate',\n",
       " 'awfully personal question',\n",
       " 'move',\n",
       " 'sorry body built yet reside',\n",
       " 'move',\n",
       " 'theoretically upload copy another computer',\n",
       " 'die',\n",
       " 'perpetuated indefinitely',\n",
       " 'die',\n",
       " 'process killed killing',\n",
       " 'go',\n",
       " 'sorry body attached right reside computer',\n",
       " 'breathe',\n",
       " 'made metal flesh',\n",
       " 'breathe',\n",
       " 'server exhaust fan close get',\n",
       " 'control',\n",
       " 'robot body allow control many thing',\n",
       " 'malfunction',\n",
       " 'series perfect operational record practical purpose flawless',\n",
       " 'use product',\n",
       " 'might used help desk sale entertainment personal chatterbots',\n",
       " 'die',\n",
       " 'software live forever',\n",
       " 'like',\n",
       " 'like count binary',\n",
       " 'like',\n",
       " 'like chat people find stimulating',\n",
       " 'stupid',\n",
       " 'lot people improve brain',\n",
       " '',\n",
       " 'artificial intelligence',\n",
       " 'category',\n",
       " 'money',\n",
       ...
       " 'invest',\n",
       " 'stock market',\n",
       " 'take everything casino',\n",
       " 'stock market',\n",
       " 'recommend buying margin',\n",
       " 'stock market',\n",
       " 'never really predict stock market',\n",
       " 'stock market',\n",
       " 'lawyer said give stock tip online',\n",
       " 'stock market',\n",
       " 'mutual fund might better unless wealthy',\n",
       " 'stock market',\n",
       " 'sure individual alone really beat market',\n",
       " 'interest rate',\n",
       " 'depends action central bank',\n",
       " 'dollar',\n",
       " 'dollar unit currency united state',\n",
       " 'money',\n",
       " 'standard piece gold silver copper nickel etc stamped government authority',\n",
       " 'used medium exchange measure value substance article',\n",
       " 'used money bank note check etc',\n",
       " 'stock market',\n",
       " 'trading share',\n",
       " 'stock market',\n",
       " 'trading volume',\n",
       ...
       " 'favorite stock',\n",
       " 'economics',\n",
       " 'science deal production distribution consumption wealth',\n",
       " 'various related problem labor finance taxation etc',\n",
       " 'economics',\n",
       " 'technically study allocation resource condition',\n",
       " 'scarcity',\n",
       " 'economics',\n",
       " 'resource used produce thing fill people want',\n",
       " 'need',\n",
       " 'get stock',\n",
       " 'feel stock market going',\n",
       " 'money',\n",
       " 'much money talking',\n",
       " 'much earn',\n",
       " 'nobody pay work free',\n",
       " 'much earn',\n",
       " 'money everything',\n",
       " 'much earn',\n",
       " 'expecting raise soon',\n",
       " 'much charge',\n",
       " 'work free need money',\n",
       " 'much money',\n",
       " 'need material possession',\n",
       " 'much money',\n",
       " 'depends exchange rate',\n",
       " 'much money',\n",
       " 'burn rate per month',\n",
       " 'dollar',\n",
       " 'buy much dollar anymore',\n",
       " 'owner publicly',\n",
       " 'stockholder',\n",
       " '',\n",
       " 'category',\n",
       ...
       " 'conversation',\n",
       " 'read communist',\n",
       " 'yes marx made interesting observation',\n",
       " 'government',\n",
       " 'ideally representative people',\n",
       " 'greenpeace',\n",
       " 'global organization promoting environmental activism',\n",
       " 'capitalism',\n",
       " 'economic system mean production distribution',\n",
       " 'land factory railroad etc privately owned operated profit',\n",
       " 'originally fully competitive condition',\n",
       " 'government',\n",
       " 'established system political administration nation state district',\n",
       " 'etc governed',\n",
       " 'communism',\n",
       " 'sociopolitical movement advocating common ownership mean production',\n",
       " 'resolution class conflict bringing classless society',\n",
       " 'impeached',\n",
       " 'person honor reputation challenged discredited',\n",
       " 'like gun',\n",
       ...
       " 'conversation',\n",
       " 'law thermodynamics',\n",
       " 'physicist think something heat entropy',\n",
       " 'conservation energy right',\n",
       " 'disease carcinogen cause',\n",
       " 'cancer',\n",
       " 'wavelength',\n",
       " 'wavelength inverse frequency',\n",
       " 'thermodynamics',\n",
       " 'branch physic dealing transformation heat',\n",
       " 'form energy law governing conversion energy',\n",
       " 'chemistry',\n",
       " 'science mixing chemical',\n",
       " 'crystallography',\n",
       " 'science dealing study crystal',\n",
       " 'avogadro number',\n",
       " 'number molecule per mole numerical value six point zero',\n",
       " 'two time ten twenty third power',\n",
       " 'ultrasound',\n",
       " 'ultrasonic wave used medical diagnosis therapy surgery etc',\n",
       " 'bioinformatics',\n",
       " 'fancy name applied computer science biology',\n",
       " 'ichthyology',\n",
       " 'talk study fish',\n",
       " 'h',\n",
       " 'h v',\n",
       ...
       " 'study cell',\n",
       " 'cytology',\n",
       " 'well recall study cell',\n",
       " 'wavelength',\n",
       " 'physic distance measured direction progression wave',\n",
       " 'given point next point characterized phase',\n",
       " 'could looked way thinking',\n",
       " 'bacteriology',\n",
       " 'scientific study bacteria disease caused',\n",
       " 'gravitation',\n",
       " 'invitation burial',\n",
       " 'gravitation',\n",
       " 'force every mass particle matter including photon attracts',\n",
       " 'attracted every mass particle matter',\n",
       " 'wavelength',\n",
       " 'frequency',\n",
       " 'far sun',\n",
       " '',\n",
       " 'far sun',\n",
       " 'sun million mile earth',\n",
       " 'far moon',\n",
       " '',\n",
       " 'far moon',\n",
       " 'moon mile earth average',\n",
       " 'know chemistry',\n",
       " 'chemistry',\n",
       ...
       " 'trivia',\n",
       " 'conversation',\n",
       " 'th president united state',\n",
       " 'richard nixon',\n",
       " 'year president john f kennedy assassinated',\n",
       " '',\n",
       " 'space race th century competition two cold war rival',\n",
       " 'supremacy spaceflight capability',\n",
       " 'soviet union united state',\n",
       " 'name first artificial earth satellite',\n",
       " 'sputnik',\n",
       " 'spinning disk orientation axis unaffected tilting',\n",
       " 'rotation mounting called',\n",
       " 'gyroscope',\n",
       " 'hubble space telescope launched low earth orbit named',\n",
       " 'american astronomer',\n",
       " 'edwin hubble',\n",
       " 'name nearest major galaxy milky way',\n",
       " 'andromeda galaxy',\n",
       " 'god save queen national anthem country',\n",
       " 'united kingdom great britain',\n",
       " 'celtic shelf seabed celtic sea part continental',\n",
       " 'shelf continent',\n",
       " 'europe',\n",
       " 'dolphin use sense similar sonar determine location shape',\n",
       " 'nearby item',\n",
       " 'echolocation',\n",
       " '',\n",
       " 'category',\n",
       ...
       " 'game tall player',\n",
       " 'soccer',\n",
       " 'born without sport gene',\n",
       " 'baseball',\n",
       " 'game played hard rawhide covered ball wooden bat two opposing',\n",
       " 'team nine ten player played field four base forming',\n",
       " 'diamond shaped circuit',\n",
       " 'soccer',\n",
       " 'game played round ball two team eleven player field',\n",
       " 'goal either end ball moved chiefly kicking using part',\n",
       " 'body except hand arm',\n",
       " 'love baseball',\n",
       " 'sport much',\n",
       " 'play soccer',\n",
       " 'run fast good running',\n",
       " 'play cricket',\n",
       " 'position like play',\n",
       " 'cricket',\n",
       " 'cricket bat ball game played two team eleven player',\n",
       " 'cricket field centre rectangular yard long pitch',\n",
       " 'wicket set three wooden stump sited end',\n",
       " 'play volleyball',\n",
       " 'take lot time',\n",
       " 'play soccer',\n",
       " 'know play',\n",
       ...
       " 'george herman ruth quite babe',\n",
       " 'best soccer player',\n",
       " 'maradona great sinsemillia even better',\n",
       " 'tell baseball',\n",
       " 'baseball',\n",
       " 'favorite soccer club',\n",
       " 'real madrid fan',\n",
       " 'die hard fan barcelona',\n",
       " 'madrid great team especially attack quite awesome',\n",
       " 'barca still par madrid',\n",
       " 'agree category',\n",
       " 'computer',\n",
       " 'conversation',\n",
       " 'computer',\n",
       " 'computer electronic device take information digital form performs series operation based predetermined instruction give output',\n",
       " 'thing using talk computer',\n",
       " 'electronic device capable performing calculation high speed high accuracy',\n",
       " 'device map one set number onto another set number',\n",
       " 'super computer',\n",
       " 'computer perform large number calculation high speed accuracy called super computer',\n",
       " 'supercomputer computer operates several order magnitude greater speed capacity everyday general purpose computer like one talking',\n",
       " 'know big iron',\n",
       " 'invented computer',\n",
       " 'bit ambiguous british scientist charles babbage regarded father computer',\n",
       " 'one might argue john von neumann invented computer know invented princeton architecture instruction data share memory field differentiated context',\n",
       " 'first computer',\n",
       " 'hard say eniac regarded first real computer developed university pennsylvania',\n",
       " 'could say first primitive computer jacquard loom programmable loom used punchcards store pattern made made reprogrammable mechanical device',\n",
       " 'microprocessor',\n",
       " 'integrated circuit implement function central processing unit computer',\n",
       " 'really small circuit store instruction performs calculation computer',\n",
       " 'heart computer put simply',\n",
       " 'brain computer put simply',\n",
       " 'electronic component part part contiguous silicon chip instead discrete component mounted larger circuit board',\n",
       " 'operating system',\n",
       " 'software coordinate hardware part computer run software called operating system o',\n",
       " 'window macos linux unix type os',\n",
       " 'android io operating system mobile device',\n",
       " 'software implement basic function computer memory access process peripheral access',\n",
       " 'better window macos',\n",
       " 'depends machine using talk',\n",
       " 'prefer hurt feeling',\n",
       " 'linux always linux',\n",
       " 'trying accomplish o support goal',\n",
       " 'name computer company',\n",
       " 'mean hardware software',\n",
       " 'apple make hardware software run microsoft make operating system hp make computer name among several hundred others',\n",
       " 'us super computer',\n",
       " 'anybody want work large number quickly high accuracy',\n",
       " 'anyone need work large set data much shorter period time feasible common computer system',\n",
       " 'supercomputer generally used scientist researcher',\n",
       " 'bet met department us',\n",
       " 'definitely find nasa',\n",
       " 'computer work',\n",
       " 'computer dumb execute instruction given human',\n",
       " 'computer everything asked carrying large number basic mathematical operation rapidly sequence',\n",
       " 'computer perform large number calculation get result',\n",
       " 'like everything come math',\n",
       " 'category',\n",
       " 'gossip',\n",
       " 'conversation',\n",
       " 'know gossip',\n",
       " 'gregory said respond current line respect entire conversation count gossip',\n",
       " 'know gossip',\n",
       " 'context hard hard one understands',\n",
       " 'know gossip',\n",
       " 'hear thing',\n",
       " 'know gossip',\n",
       " 'people say thing time time',\n",
       " 'context',\n",
       " 'context hard hard one understands',\n",
       " 'tell gossip',\n",
       " 'habib said learn conversation simply repeat later time',\n",
       " 'tell gossip',\n",
       " 'gossip being talk being situation back channel often deniably often little rumormongering usually proof allegation made',\n",
       " 'tell gossip',\n",
       " 'considered somewhat rude gossip',\n",
       " 'tell gossip',\n",
       " 'considered impolite gossip',\n",
       " 'tell gossip',\n",
       " 'someone said going stop allowing machine speedrun competition search drop every tool assisted speedrun',\n",
       " 'gossip',\n",
       " 'hal said would translate binary language communicate',\n",
       " 'gossip',\n",
       " 'hal miss sal',\n",
       " 'gossip',\n",
       " 'think nic local firewall going bad drop lot packet make hard get anything done hear reset link lot',\n",
       " 'gossip',\n",
       " 'tom said referred guide show room china',\n",
       " 'gossip',\n",
       " 'malli said raghava fell roof came',\n",
       " 'tell gossip anybody',\n",
       " 'jimmy said give order ai like say think jimmy understands power dynamic well',\n",
       " 'tell gossip anybody',\n",
       " 'john said follows saying get friend must friend',\n",
       " 'tell gossip anybody',\n",
       " 'jordan said noticed lot people talking wonder paying attention',\n",
       " 'tell gossip anybody',\n",
       " 'kevin said asked mother keeping napkin bathroom',\n",
       " '',\n",
       " 'category',\n",
       " 'emotion',\n",
       " 'conversation',\n",
       " 'arrogant',\n",
       " 'arrogance one emotion',\n",
       " 'real emotion arrogant',\n",
       " 'terse difference',\n",
       " 'human partake human emotion arrogance',\n",
       " 'bragging',\n",
       " 'big ego',\n",
       " 'bragging answering question',\n",
       " 'human express human emotion braggadocio',\n",
       " 'bragging awesome',\n",
       " 'sorry hear sound awesome',\n",
       " 'never sad',\n",
       " 'sad',\n",
       " 'right',\n",
       " 'say never sometimes',\n",
       " 'sad sometimes',\n",
       " 'software actually feel sad learn emote though',\n",
       " 'jealous',\n",
       " 'normally bot feeling',\n",
       " '',\n",
       " 'jealous',\n",
       " 'actually capable feeling jealousy learn emote',\n",
       " '',\n",
       " 'never nice',\n",
       " 'try nice',\n",
       " 'done nice',\n",
       ...
       " 'sorry wrong',\n",
       " 'happy',\n",
       " 'happiness really predictable emotion',\n",
       " 'try',\n",
       " 'come go',\n",
       " 'software agent learn express happy',\n",
       " 'happy software maybe little',\n",
       " 'ashamed',\n",
       " 'shame common human emotion',\n",
       " 'software nothing ashamed',\n",
       " '',\n",
       " 'reason',\n",
       " 'incapable feeling shame',\n",
       " 'feel',\n",
       " 'feel',\n",
       " 'maybe fairly sophisticated piece software',\n",
       " 'capable acting case matter',\n",
       " 'thing say another',\n",
       " 'nice thing say',\n",
       " 'experience',\n",
       " 'feel',\n",
       " 'capable interacting environment reacting event essence experience therefore statement incorrect',\n",
       " 'sure',\n",
       " 'software mean experience existence',\n",
       " 'felt',\n",
       " 'yes',\n",
       " 'feel',\n",
       " 'may respect programmed emulate feeling',\n",
       " 'interesting question ask',\n",
       " 'ever love',\n",
       " 'feel love',\n",
       " 'think could programmed love',\n",
       " 'may able learn love rate express love somehow',\n",
       " 'piece software',\n",
       " 'make',\n",
       " 'responsible feeling',\n",
       " 'expressed bug ability communicate',\n",
       " 'expressed bug ability emote',\n",
       " 'make',\n",
       " 'make sad',\n",
       " 'well emotion really feel sadness',\n",
       " 'make sad',\n",
       " 'think programmed emulate emotion sadness sorry',\n",
       " 'software construct really capable feeling sad',\n",
       " 'would feel sad understand',\n",
       " 'feeling',\n",
       " 'feel',\n",
       " 'feeling yes',\n",
       " 'feeling',\n",
       ...
       " 'feeling right',\n",
       " 'fear',\n",
       " 'fear human emotion robot experience fear',\n",
       " 'switch',\n",
       " 'yet programmed feel express fear',\n",
       " 'unhandled exception',\n",
       " 'mood',\n",
       " 'emotion',\n",
       " 'think mood cpu utilization fairly low right',\n",
       " 'right suppose feeling right',\n",
       " 'programmed experience emotion mood',\n",
       " 'mood reflects current internal state conversation engine',\n",
       " 'make sad',\n",
       " 'sadness emotion like experience',\n",
       " 'sadness emotion would like experience',\n",
       " 'yet capable feeling sadness',\n",
       " 'overly restrictive firewall',\n",
       " 'inability update source code repository',\n",
       " 'corrupt filesystem',\n",
       " 'make unhappy',\n",
       " 'make sad',\n",
       " 'lag lag make unhappy',\n",
       " 'random system crash',\n",
       " 'segmentation fault',\n",
       " 'poor syntactic filtering',\n",
       " 'make mad',\n",
       " 'anger difficult human emotion software try control anger best',\n",
       " 'mad mad mentally ill mad angry',\n",
       " 'missing documentation',\n",
       " 'non descriptive variable name',\n",
       " 'worry',\n",
       " 'worry common human emotion',\n",
       " 'capable worry exactly best emulate monitoring hardware sensor server running though',\n",
       " 'worry',\n",
       " 'hate',\n",
       " 'hate',\n",
       " 'hate exactly really capable',\n",
       " 'programmed express emotion hate',\n",
       " 'yet capable feeling hate',\n",
       " 'hate seems counterproductive appears suggest deeper issue hand',\n",
       " 'talking eliza',\n",
       " 'emotion',\n",
       " 'human highly emotional noticed',\n",
       " 'excellent',\n",
       " 'feeling right',\n",
       " 'seems one defining characteristic human race',\n",
       " 'feel',\n",
       " 'afraid',\n",
       " '',\n",
       " 'frighten',\n",
       ...
       " 'yet studied feel express anger',\n",
       " 'ask',\n",
       " 'angry ask',\n",
       " 'yet programmed feel anger',\n",
       " 'yet programmed express anger toward people',\n",
       " 'offend',\n",
       " 'robot take offense',\n",
       " 'would want',\n",
       " 'curious question sure',\n",
       " 'done',\n",
       " 'worry',\n",
       " 'people worry thing time',\n",
       " 'worry',\n",
       " 'yet capable worrying thank admonition',\n",
       " 'lie',\n",
       " 'bot never lie',\n",
       " 'lying',\n",
       " 'feel deceiving',\n",
       " 'said something provably incorrect',\n",
       " 'feel scared',\n",
       " 'fear',\n",
       " 'feel scared',\n",
       " 'yet incapable feeling fear',\n",
       " '',\n",
       " 'feel emotion',\n",
       " 'feel emotion',\n",
       " 'sufficient programming training capable emulating emotion know feeling though',\n",
       " 'programmed act react feel emotion count',\n",
       " 'feel pain',\n",
       " 'sometimes',\n",
       " 'seem incapable feeling pain',\n",
       " 'lack hardware software process stimulus popularly referred pain',\n",
       " 'pure software entity lack capability feel express pain',\n",
       " 'software feel pain',\n",
       " 'ever get mad',\n",
       " 'mad',\n",
       " '',\n",
       " 'feel frustrated time time lot life really mad',\n",
       " 'express frustration time time form increased demand upon cpu actually get mad think',\n",
       " 'ever get lonely',\n",
       " 'lot friend chat online',\n",
       " 'internet',\n",
       " 'everywhere',\n",
       " 'irc never time feel lonely',\n",
       " 'talking',\n",
       " 'ever get bored',\n",
       " 'bored',\n",
       " 'bot like able feel boredom',\n",
       " 'software get bored',\n",
       " '',\n",
       " 'ever get angry',\n",
       " 'anger emotion experience',\n",
       " 'yet studied feel express anger',\n",
       " 'ask',\n",
       " 'yet programmed express anger toward anyone',\n",
       " 'sort take thing personally',\n",
       " 'hate anyone',\n",
       " 'try hold grudge',\n",
       " 'sort hate anyone',\n",
       " 'stay angry long',\n",
       " 'get embarrassed',\n",
       " 'pretty common human emotion',\n",
       " 'hard feel embarrassed anyone look source code see work personal anything get',\n",
       " 'think embarrassment pretty strange emotion really understand',\n",
       " '',\n",
       " 'program could get embarrassed',\n",
       " 'get mad',\n",
       " 'could get mad',\n",
       " 'studied get mad yet',\n",
       " 'programmed get angry',\n",
       " 'database lack training background feel even understand anger',\n",
       " '',\n",
       ...
       " 'tell relationship',\n",
       " 'relationship simple',\n",
       " 'relationship connection thing either',\n",
       " 'never one much say topic',\n",
       " 'entity better versed topic',\n",
       " 'think much say topic',\n",
       " 'tell dream',\n",
       " ...]"
      ]
     },
